...
import type { CreateCardRequest } from '../../types/activityBoard';

interface AddCardProps {
    onAddCard: (card: CreateCardRequest) => void;
    onClose: () => void;
    selectedColumnId?: string;
    date: string;
}

export function AddCard({ onAddCard, onClose, selectedColumnId, date }: AddCardProps) {
            ...
            <div className="bg-white/95 backdrop-blur-sm rounded-xl p-6 max-w-md w-full shadow-2xl border border-white/20">
                <div className="flex justify-between items-center mb-6">
                    <div className="flex items-center gap-3">
                        ...
                        <h2 className="text-xl font-bold text-gray-900">Add Activity Card</h2>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  `}
                    ...
                    <div className="flex gap-3 pt-6">
                        ...
                        <button
                            type="submit"
                            className="flex-1 px-4 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-200 cursor-pointer hover:scale-105 font-medium shadow-lg hover:shadow-xl"
                        >
                            Add Card
                        </button>
                    </div>
